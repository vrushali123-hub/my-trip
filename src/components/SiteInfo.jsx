      ...
      <div className="container">
        <div className="row g-4">
          <div className="col-md-4">
            <h6 className="text-dark mb-2">MakeMyTrip</h6>
            <p>
          ...
          <div className="col-md-4">
            <h6 className="text-dark mb-2">About the Site</h6>
            <p>
          ...
          <div className="col-md-4">
            <h6 className="text-dark mb-2">Product Offering</h6>
            <p>
              Flights, International Flights, Charter Flights, Hotels,
              International Hotels, Homestays and Villas, Activities, Holidays In India,
